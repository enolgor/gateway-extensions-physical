...
public class Activator implements BundleActivator{
	...
	public void start(BundleContext context) throws Exception {
		...
		DeviceControllerFactory deviceControllerFactory = DeviceControllerFactory.generic(ArduinoUnoFirmataDeviceController.class);
		Hashtable<String, String> serviceProperties = new Hashtable<>();
		serviceProperties.put("controller-key", "arduino-uno");
